      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-3">
                <!-- WhatsApp -->
                <a [href]="'https://wa.me/' + config().whatsapp" target="_blank" class="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-green-600 hover:text-white transition-all duration-300 text-white shadow-md border border-slate-700">
                ...
                <!-- Instagram -->
                <a [href]="config().instagramUrl" target="_blank" class="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-pink-600 hover:text-white transition-all duration-300 text-white shadow-md border border-slate-700">
                ...
                <!-- X (Twitter) -->
                <a [href]="config().twitterUrl" target="_blank" class="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-black hover:text-white transition-all duration-300 text-white shadow-md border border-slate-700">
                ...
                <!-- YouTube -->
                <a [href]="config().youtubeUrl" target="_blank" class="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-red-600 hover:text-white transition-all duration-300 text-white shadow-md border border-slate-700">
          ...
          <div>
            ...
            <ul class="space-y-4 text-sm">
              ...
              <li class="flex items-center">
                ...
                <a [href]="'tel:' + config().whatsapp" class="text-white font-bold hover:text-amber-500 transition-colors">{{ config().phone }}</a>
              </li>
              <li class="flex items-center">
        ...
        <div class="border-t border-slate-900 py-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-600">
          ...
          <div class="flex items-center">
             <span>&copy; 2024 {{ config().companyName }}. Tüm hakları saklıdır.</span>
             <!-- Hidden Admin Link -->
             <a routerLink="/admin/login" class="ml-2 opacity-20 hover:opacity-100 hover:text-amber-500 transition-all p-1" title="Yönetici Girişi">
